...
5. **Difference Between OLTP and OLAP:**
    - OLTP processes real-time transaction data (e.g., customer orders), while OLAP analyzes historical data for complex queries (e.g., net profit analysis).
...
2. **Creating Parameters in Parameter Store:**
...
3. **Automated Rotation and Encryption:**
    - Secrets Manager allows you to automate the rotation of secrets, such as database passwords, using AWS Lambda functions. Rotation can be scheduled at regular intervals.
...
1. **Introduction to EC2 Image Builder:**
    - EC2 Image Builder is a service that allows you to create and manage virtual machine images (Amazon Machine Images) and container images in AWS.
